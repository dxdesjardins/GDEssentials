...
2. Create a scene with a single StageManager node. Configure the StageManager with the path to the directory containing your stages. Next, you can EITHER:
   1. Set the StageManager scene as an autoload. All loaded stages will become children of the tree root.
   2. Set the StageManager scene as your main scene. All loaded stages will become children of the StageManager. This is ideal for 2D games which need to enable `Y Sort`.
